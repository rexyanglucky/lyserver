    ...
    delArticleDraft(...id) {
        return new Promise((resolve, reject) => {
            this.dbHelper.DeleteDB({
                collectionName: "articleDraft", query: { _id: (0, _mongodb.ObjectId)(id[0]) }, callback: result => {
                    // callback(result);
                    resolve(result);
                } });
    ...
    addVisitCount(id) {
        try {
            this.dbHelper.UpdateDB({
                ...
                data: { $inc: { 'vcount': 1 } },
                query: { _id: (0, _mongodb.ObjectId)(id) },
    ...
    _updateArticleHistory(realid, set) {
        return new Promise((resolve, reject) => {
            this.dbHelper.UpdateDB({
                ...
                query: { realid: (0, _mongodb.ObjectId)(realid) },
                callback: result => {
                    resolve(result);
                } });
...
ArticleBll;
//# sourceMappingURL=articleV2.js.map